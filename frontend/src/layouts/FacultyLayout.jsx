        ...
        <div className={`absolute inset-y-0 left-0 w-72 ${
          ...
          <div className={`flex h-16 items-center justify-between px-6 border-b ${
            ...
            <div className="flex items-center space-x-2">
              ...
              <h1 className={`text-xl font-bold ${darkMode ? 'text-white' : 'text-gray-900'}`}>Faculty Portal</h1>
            </div>
            <button
              onClick={() => setSidebarOpen(false)}
                ...
                <NavLink
                  ...
                  className={({ isActive }) =>
                    `flex items-center px-3 py-2.5 text-sm font-medium rounded-lg mb-1 transition-all duration-200 group ${
                      isActive 
                        ? darkMode ? 'bg-gray-800 text-white' : 'bg-green-50 text-green-600'
                        : darkMode ? 'text-gray-300 hover:bg-gray-800 hover:text-white' : 'text-gray-700 hover:bg-gray-100'
                    }`
                  }
                >
                  <item.icon className={`mr-3 h-5 w-5 ${
                    darkMode ? 'text-gray-500 group-hover:text-white' : 'text-gray-500 group-hover:text-green-600'
                  }`} />
                  <span>{item.name}</span>
                </NavLink>
              ))}
